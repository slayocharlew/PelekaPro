...
@section('content')
    ...
    <div class="portal-delivery-browser" data-delivery-browser aria-busy="false">
        <form class="portal-filter-card" method="GET" action="{{ route('portal.deliveries.index') }}" data-delivery-filter-form>
            <div class="portal-field portal-field--search">
                <label for="search">Search</label>
                <input id="search" name="search" type="search" value="{{ $filters['search'] ?? '' }}" placeholder="Delivery number, tracking code, customer" autocomplete="off">
            </div>
            ...
            <div class="portal-filter-card__actions">
                ...
                <a class="portal-button portal-button--quiet" href="{{ route('portal.deliveries.index') }}" data-delivery-ajax-link>Clear</a>
            </div>
        </form>

        <p class="sr-only" role="status" aria-live="polite" data-delivery-filter-status></p>

        <section class="portal-card" aria-labelledby="delivery-results-heading" data-delivery-results>
                                ...
                                <tr>
                                    ...
                                    <td class="portal-table__actions">
                                        ...
                                        @if (in_array($delivery->getKey(), $cancellableDeliveryIds, true))
                                            <form method="POST" action="{{ route('portal.deliveries.cancel', $delivery) }}" data-confirm="Cancel this delivery?" data-submitting-form>
                                                @csrf
